...
[r/unixp*rn](https://www.reddit.com/r/unixporn/)でおしゃれなデスクトップが上がってたので興味湧いて使っていましたがgnome,xfce etc.が触るのがめんどくさくなりました
...
**ArchLinux**ならビルドぜずcommunityから入ります！
...
上記は$mod+Shift+qはきついので$mod+qでソフト終了できるようにしてます
...
私のautostart.shは
https://github.com/soracqt/config-artix/blob/master/dotfiles/.config/i3/autostart.sh
です
...
2022/06/19追記 [dex](https://wiki.archlinux.org/title/XDG_Autostart)と言う物があります
